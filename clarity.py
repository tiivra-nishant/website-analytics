...
with open('./reports/april01-07_2024/clarity.csv') as csv_file:
    ...
    referral_sources = {'facebook': 0, 'tiivra': 0, 'instagram': 0, 'google': 0, 'linktr.ee': 0, 'youtube': 0, 'shiprocket': 0, 'meta': 0, 'other': 0}
    ...
    # Data numbers 
    print('Total Sessions:', total_clarity_sessions)
